(function() {
  var GraphemeBreaker, expect, fs, punycode;
  ...
  describe('GraphemeBreaker', function() {
    ...
    it('should pass all tests in GraphemeBreakTest.txt', function() {
      var codePoints, cols, comment, data, expected, j, len, line, lines, ref, results, str;
      ...
      for (j = 0, len = lines.length; j < len; j++) {
        ...
        ref = line.split('#'), cols = ref[0], comment = ref[1];
    ...
    return it('should pass all tests in GraphemeBreakTest.txt in reverse', function() {
      var brk, codePoints, cols, comment, data, expected, index, j, len, line, lines, ref, res, results, str;
      data = fs.readFileSync(__dirname + '/GraphemeBreakTest.txt', 'utf8');
      lines = data.split('\n');
      results = [];
      for (j = 0, len = lines.length; j < len; j++) {
